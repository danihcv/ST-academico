...
class StudentCRUDTest {
    ...
    private Student create(String firstName, String lastName) {
        ...
        assertEquals(new ArrayList<>(), saved.getCompletedDisciplines(),
    ...
    private void get(Student student) {
        ...
        assertEquals("STUDENT", recovered.getRole(), "Role do Student recuperado não confere com o informado");
        assertEquals(student.getCredits(), recovered.getCredits(), "Credits do Student recuperado não confere com o informado");
        assertEquals(student.getCompletedDisciplines().size(), recovered.getCompletedDisciplines().size(),
                "Quantidade de Completed Disciplines do Student recuperado não confere com a informada");
    }
